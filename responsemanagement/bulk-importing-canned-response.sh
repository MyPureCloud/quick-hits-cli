...
Step 1:  Create the Libraries: echo '{"name": "Bulk Example Library","version": 1}' | gc responsemanagement libraries create | jq -r .id
...
for f in canned*;do cat "$f" | gc responsemanagement responses create;done
