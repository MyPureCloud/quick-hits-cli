# >> START update-acdAutoAnswer.sh Use the experimental transform feature in the CLI along with a Go template to filter and then do a bulk update of the autoAcdAnswer 
